...
namespace Shashlik.EventBus
{
    ...
    {
        public static IEventBusBuilder AddEventBus(this IServiceCollection serviceCollection, Action<EventBusOptions> configure)
        {
            serviceCollection.Configure(configure);
            return serviceCollection.AddEventBus();
        }

        public static IEventBusBuilder AddEventBus(this IServiceCollection serviceCollection, IConfigurationSection configuration)
        {
        ...
        {
            serviceCollection.TryAddSingleton<IMessageIdGenerator, GuidMessageIdGenerator>();
            ...
            {
                serviceCollection.Add(new ServiceDescriptor(eventHandlerDescriptor.EventHandlerType, eventHandlerDescriptor.EventHandlerType, options.Value.HandlerServiceLifetime));
            }
