...
public abstract class RelationDbMessageStorageBase : IMessageStorage
{
    ...
    ///     true值
    /// </summary>
    protected virtual string BoolTrueValue
    {
        get { return "1"; }
    }
    ...
    ///     false值
    /// </summary>
    protected virtual string BoolFalseValue
    {
        get { return "0"; }
    }

    public virtual async ValueTask<bool> IsCommittedAsync(string messageId, CancellationToken cancellationToken = default)
    {
        var sql =
    ...
    public virtual async Task<MessageStorageModel> FindPublishedByMsgIdAsync(string messageId, CancellationToken cancellationToken)
    {
        var sql = $"SELECT * FROM {PublishedTableName} WHERE {SqlTagCharPrefix}msgId{SqlTagCharSuffix} = @msgId;";
        return await QueryOneModelAsync(sql, new { msgId = messageId, }, cancellationToken)
                   .ConfigureAwait(false);
    }

    public virtual async Task<MessageStorageModel> FindPublishedByIdAsync(string storageId, CancellationToken cancellationToken)
    {
    ...
    public virtual async Task<MessageStorageModel> FindReceivedByMsgIdAsync(string messageId, EventHandlerDescriptor eventHandlerDescriptor, CancellationToken cancellationToken = default)
    {
        var sql =
        ...
        return await QueryOneModelAsync(sql,
                                        new { msgId = messageId, eventHandlerName = eventHandlerDescriptor.EventHandlerName, }, cancellationToken)
                   .ConfigureAwait(false);
    }

    public virtual async Task<MessageStorageModel> FindReceivedByIdAsync(string storageId, CancellationToken cancellationToken)
    {
    ...
    public virtual async Task<List<MessageStorageModel>> SearchPublishedAsync(string eventName, MessageStatus status, int skip, int take, CancellationToken cancellationToken)
    {
...
";
    ...
    public virtual async Task<List<MessageStorageModel>> SearchReceivedAsync(string eventName, string eventHandlerName, MessageStatus status, int skip, int take, CancellationToken cancellationToken)
    {
        var where = new StringBuilder();
        if (!eventName.IsNullOrWhiteSpace())
        {
...
";
    ...
    public virtual async Task<string> SavePublishedAsync(MessageStorageModel message, ITransactionContext transactionContext, CancellationToken cancellationToken = default)
    {
        var sql = $@"
...
;";
    ...
    public virtual async Task<string> SaveReceivedAsync(MessageStorageModel message, CancellationToken cancellationToken = default)
    {
        var sql = $@"
...
;";
    ...
    public virtual async Task UpdatePublishedAsync(string storageId, MessageStatus status, int retryCount, DateTimeOffset? expireTime, CancellationToken cancellationToken = default)
    {
        var sql = $@"
...
;";
    ...
    public virtual async Task UpdateReceivedAsync(string storageId, MessageStatus status, int retryCount, DateTimeOffset? expireTime, CancellationToken cancellationToken = default)
    {
        if (storageId == null)
        {
...
;";
    ...
    public virtual async Task<Dictionary<MessageStatus, int>> GetPublishedMessageStatusCountsAsync(CancellationToken cancellationToken)
    {
        var sql =
        ...
        {
            return new Dictionary<MessageStatus, int>();
        }

        return list!.ToDictionary(r => (MessageStatus)r.status, r => (int)r.c);
    }

    public virtual async Task<Dictionary<MessageStatus, int>> GetReceivedMessageStatusCountAsync(CancellationToken cancellationToken)
    {
        var sql =
    ...
    protected virtual async Task<MessageStorageModel> QueryOneModelAsync(string sql, object ps, CancellationToken cancellationToken = default)
    {
    ...
    protected virtual async Task<List<MessageStorageModel>> QueryModelAsync(string sql, object ps, CancellationToken cancellationToken = default)
    {
        using var dbConnection = CreateConnection();
        dbConnection.Open();
    ...
    protected virtual async Task<TRes> ScalarAsync<TRes>(string sql, object ps, CancellationToken cancellationToken = default)
    {
        using var dbConnection = CreateConnection();
        dbConnection.Open();
    ...
    protected virtual async Task<int> NonQueryAsync(string sql, object ps, CancellationToken cancellationToken = default)
    {
        using var dbConnection = CreateConnection();
        dbConnection.Open();
    ...
    protected virtual async Task<TRes> ScalarAsync<TRes>(ITransactionContext transactionContext, string sql, object ps, CancellationToken cancellationToken = default)
    {
        ...
        return await connection
                     .ExecuteScalarAsync<TRes>(sql, ps, relationDbStorageTransactionContext.DbTransaction)
                     .ConfigureAwait(false);
    }
}