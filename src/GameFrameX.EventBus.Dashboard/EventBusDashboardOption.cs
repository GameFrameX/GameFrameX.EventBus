namespace GameFrameX.EventBus.Dashboard
{
    ...
    public class EventBusDashboardOption
    {
        ...
        public const string DataProtectorName = "GameFrameX.GameFrameX.EventBus.Dashboard";
        ...
        /// <returns></returns>
        public EventBusDashboardOption UseAuthenticate<T>() where T : IEventBusDashboardAuthentication
        {
        ...
        /// <returns></returns>
        public EventBusDashboardOption UseSecretAuthenticate(string authenticateSecret, string authenticateSecretCookieName = null, Func<HttpContext, CookieOptions> authenticateSecretCookieOptions = null)
        {
